...
process vg {    
    ...
    script:
    def gbz  = params.vg_pangenome_gbz ?: "${params.DB}/hg38/panGenome/hprc-v1.1-mc-grch38.gbz"
    def hapl = params.vg_pangenome_hapl ?: "${params.DB}/hg38/panGenome/hprc-v1.1-mc-grch38.hapl"
